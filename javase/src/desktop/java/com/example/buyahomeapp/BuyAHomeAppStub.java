 ...
 * @author Shai Almog
 */
public class BuyAHomeAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "BuyAHomeApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new BuyAHomeAppStub());
    }
