iOS Push certificates have been created for your app with bundle ID com.example.buyahomeapp.  Please keep this file as you will need the details about the certificate locations and passwords to use Push successfully in your apps.
